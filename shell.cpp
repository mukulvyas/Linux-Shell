...
void Shell::parseAndExecuteCommand(const string& input) {
...
bool Shell::containsHelpOption(const vector<string>& tokens) {
...
void Shell::changeDirectory(const vector<string>& tokens) {
    if (tokens.size() > 1) {
...
void Shell::listDirectoryContents(const vector<string>& tokens) {
...
string Shell::execute(const char* cmd)  {
    char buffer[128];
    string result = "";
...
void Shell::displayHelp(const string& command) {
     if (command == "cd") {
        ...
        cout << "    -P is used; non-zero otherwise.\n";      
            ...
            string output = execute("ls --help");
            cout << "\nOutput:\n" << output << endl;
        } else if (command == "mv") {
            string output = execute("mv --help");
            cout << "\nOutput:\n" << output << endl;
            
        } else if (command == "rm") {
            string output = execute("rm --help");
            cout << "\nOutput:\n" << output << endl;
            
        } else if (command == "cp") {
            string output = execute("cp --help");
            cout << "\nOutput:\n" << output << endl;
            
        }
}

void Shell::listSubdirectoryContents(const string& directory,
                                      bool showHidden,
                                      bool reverseOrder,
                                      bool recursive) {
...
void Shell::moveFile(const vector<string>& tokens, const string& command) {
...
void Shell::removeFile(const vector<string>& tokens, const string& command) {
